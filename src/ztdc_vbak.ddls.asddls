...
define root view entity ZTDC_VBAK as projection on ZTDI_VBAK

  association [1..*] to ZTDC_VBAP as _ZTDC_VBAP on $projection.SalesDocument = _ZTDC_VBAP.SalesDocument
